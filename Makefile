FLAGS = -D NDEBUG -ggdb3 -std=c++17 -O2 -march=native -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat \
...
CXX = g++
SRC = main.cpp str.cpp hash.cpp table.cpp list.cpp
